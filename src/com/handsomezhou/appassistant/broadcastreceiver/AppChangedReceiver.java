package com.handsomezhou.appassistant.broadcastreceiver;

import com.handsomezhou.appassistant.helper.AppInfoHelper;
import com.handsomezhou.appassistant.service.AppAssistantService;
...
public class AppChangedReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		// Toast.makeText(context, "AppChangedReceiver",
		...
		if (intent.getAction().equals(Intent.ACTION_PACKAGE_ADDED)) {
			...
			AppAssistantService.startAppAssistantService(context, intent);
